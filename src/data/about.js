export const coreValues = [
  { icon: 'Heart', title: 'Mohabbat & Ikhlaas', desc: 'Deep love, sincerity, and devotion that define every aspect of community life and service.' },
  { icon: 'Users', title: 'Unity & Brotherhood', desc: 'A strong bond of togetherness where every member is treated as family with warmth and respect.' },
  { icon: 'BookOpen', title: 'Knowledge & Learning', desc: 'Commitment to both religious and secular education, nurturing minds for a brighter future.' },
  { icon: 'Globe', title: 'Service to Humanity', desc: 'Dedicated to giving back through charity, cleanliness drives, and community outreach programs.' },
];
...
export const asharaServices = [
  ...
  'Mawaid (community dining) arrangements',
  'Parking and flow management',
];
